...
export function runDemoTodoAppTests() {
  ...
  test.describe.skip("New Todo", () => {
    test(
      ...
      async ({ page }) => {
        ...
        await newTodo.press("Enter");
        console.log("Created second todo item.");
        console.error("Created second todo item?");
        console.warn("Created second todo item!");
        console.info("Created second todo item!!");
  ...
  test.describe.skip("Editing", () => {
    ...
    test("should save edits on blur", { tag: "@hello" }, async ({ page }) => {
      const todoItems = page.getByTestId("todo-item");
    ...
    test("should trim entered text", { tag: "@hello" }, async ({ page }) => {
      const todoItems = page.getByTestId("todo-item");
      await todoItems.nth(1).dblclick();
      await todoItems
        .nth(1)
