...
export function runApiTests() {
  test.describe("API Tests with Real Working Endpoints", async () => {
    ...
    test("GET /posts - Fetch posts", { tag: "@hi" }, async ({ request }) => {
      pulse.severity("High");
    ...
    test("PUT /posts/1 - Update post", { tag: "@hi" }, async ({ request }) => {
      pulse.severity("High");
    ...
    test(
      "POST /api/login - Successful auth",
      { tag: "@hi" },
      async ({ request }) => {
    ...
    test(
      "GET /posts - Response time < 1000ms",
      { tag: "@hi" },
      async ({ request }) => {
    ...
    test(
      "GET /api/users/2 - Validate nested data",
      { tag: "@hi" },
      async ({ request }) => {
